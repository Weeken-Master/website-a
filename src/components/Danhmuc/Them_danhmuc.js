...
function Them_danhmuc() {
  ...
  return (
    <>
      ...
      <Button type="primary" style={{ width: '30%'}}>Thêm</Button>
      </Input.Group>
        </Col>
...
{/*  bậc 2 */}
        ...
        <Select  placeholder="Chọn bậc cha cấp 1" style={{width:"30%", marginLeft:"1rem"}} >
...
{/*  tạo danh mục b3 */}
        ...
        <Select placeholder="Chọn bậc cha cấp 2"  style={{width:"30%", marginLeft:"1rem"}} >
        <Option value="1">aaaa</Option>
        </Select>
        <Input.Group compact style={{marginTop:"0.5rem"}}>
...
<Col style={{marginTop:"2rem"}} span={12}>
        ...
        <Select placeholder="Chọn mục cha cấp 3"  style={{width:"30%", marginLeft:"1rem"}} >
        <Option value="1">aaaa</Option>
        </Select>
        <Input.Group compact style={{marginTop:"0.5rem"}}>
